...
const saveApplicant = async () => {
    ...
    if (props.applicant && props.applicant.id || props.permit && props.permit.id) {
...
<template>
    <v-dialog v-model="show_form_modal" width="50%" persistent>
        
        <v-card>
            <v-card-title>
                <span class="text-h5">Add Permit</span>
            </v-card-title>
